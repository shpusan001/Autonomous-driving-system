...
if __name__ == "__main__":
    ...
    with driving_test_site:
        StateMachine.add('SETTING_LANE', SettingLane(), transitions={'success': 'START_S_COURSE_ONE_STEP'})
        ...
        StateMachine.add('DETECT_STOP_SIGN', DetectStopSign(), transitions={'success': 'LANE_TRACE2'})
        StateMachine.add('LANE_TRACE2', Obstacle_Detect(), transitions={'success': 'FINISH'})
