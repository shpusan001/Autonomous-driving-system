...
if __name__ == "__main__":
    ...
    with driving_test_site:
        ...
        StateMachine.add('GO_STRAIGHT2', Straight2(), transitions={'success': 'LANE_TRACE3'})
        StateMachine.add('LANE_TRACE3', LaneTrace(), transitions={'success': 'GO_LEFT'})
        StateMachine.add('GO_LEFT', Left(), transitions={'success': 'LANE_TRACE4'})
        StateMachine.add('LANE_TRACE4', LaneTrace(), transitions={'success': 'success'})
